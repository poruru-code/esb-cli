// Where: cli/internal/infra/compose/build.go
// What: Docker compose build env.
...
func BuildProject(ctx context.Context, runner CommandRunner, opts BuildOptions) error {
	...
	if opts.Verbose || opts.Stream {
		if err := runner.Run(ctx, opts.RootDir, "docker", args...); err != nil {
